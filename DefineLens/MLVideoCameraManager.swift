...
class MLVideoCameraManager: NSObject, ObservableObject {
...
extension MLVideoCameraManager: AVCaptureVideoDataOutputSampleBufferDelegate {
    func captureOutput(_ output: AVCaptureOutput, didOutput sampleBuffer: CMSampleBuffer, from connection: AVCaptureConnection) {
        processBuffer(sampleBuffer)
    }
}

extension MLVideoCameraManager {
